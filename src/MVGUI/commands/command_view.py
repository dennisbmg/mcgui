...
class CommandView(QWidget):
    def __init__(self):
        ...
        #self.btn_read_memory.clicked.connect(self.terminal.read_memory)
        #self.btn_read_memory.clicked.connect(self.display_response)
        ...
        #self.btn_load_default.clicked.connect(self.terminal.load_default)
        #self.btn_load_default.clicked.connect(self.display_response)
        ...
        #self.btn_erase_param.clicked.connect(self.terminal.erase_parameter)
        #self.btn_erase_param.clicked.connect(self.display_response)
        ...
        #self.btn_erase_logdata.clicked.connect(self.terminal.erase_log)
        #self.btn_erase_logdata.clicked.connect(self.display_response)
