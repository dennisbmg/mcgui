...
from . import piezo_variant_view
from . import piezo_variant_model
import yaml


class PiezoVariantController():
    def __init__(self, index, terminal):
        self.index = index
        self.terminal = terminal

        self.config_data = self.read_config("config_files/piezo_variant_config.yaml")
        ...
        self.view = piezo_variant_view.PiezoVariantView()
        self.model = piezo_variant_model.PiezoVariantModel()
