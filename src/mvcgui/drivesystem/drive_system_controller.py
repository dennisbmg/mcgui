...
from . import drive_system_model
from . import drivesystem_view
import yaml


class DriveSystemController():
    def __init__(self, index, terminal):
        ...
        self.view = drivesystem_view.DriveSystemView()
        self.model = drive_system_model.DriveSystemModel()
